                      ...
                      onTap: () {
                        showDialog(
                            ...
                            builder: (BuildContext context) => AlertDialog(
                                  ...
                                  content:
                                      PopUpShopChar(c: val.getEquippedChar()),
                                  actions: [
                                    ElevatedButton(
                                      onPressed: () {
                                          ...
                                          content: Row(
                                            children: [
                                              Image.asset(val
                                                  ...
                                                  .getImage()),
                                              Text(
                                                  "Set: ${val.getItemsInv()[index].getSet()}\n"
                                                  "Speed: ${val.getItemsInv()[index].getModifiers()[0]}\n"
                                                  "Resistance:${val.getItemsInv()[index].getModifiers()[1]}\n"
                                                  "Attack Speed: ${val.getItemsInv()[index].getModifiers()[2]}\n"
                                                  "Strength: ${val.getItemsInv()[index].getModifiers()[3]}"),
